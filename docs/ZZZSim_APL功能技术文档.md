...
>
> 接下来，我们将对APL中所有的参数进行介绍

> #### ▶5.1 条件类型
>
> 目前，ZSim的APL单元共支持五种类型的条件检查
>
> <table>
> <tr>
>   <td style="text-align: center;">条件类型</td>
>   <td style="text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">分隔符</td>
>   <td style="text-align: center;">检索目标</td>
>   <td>含义</td>
>   <td style="text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">开发现状</td>
> </tr>
> <tr>
...
>   <td>检查角色<code>CID</code>的过去动作</td>
...
>   <td style="text-align: center; position: relative;"></td>
>   <td>特殊类的APL类型</td>
> </tr>
> </table>
>
