        ...
        for _ in DYNAMIC_BUFF_DICT[charname][:]:
            ...
            if not _.ft.simple_exit_logic:
                ...
                if not shoud_exit:
                    ...
                    KickOutBuff(DYNAMIC_BUFF_DICT, _, charname, enemy, sub_exist_buff_dict, timetick)
                continue
            if _.ft.alltime:
...
def KickOutBuff(DYNAMIC_BUFF_DICT: dict, buff: Buff, charname: str, enemy, sub_exist_buff_dict: dict, timetick: int):
